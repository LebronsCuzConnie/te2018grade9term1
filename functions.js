...
function anyMessageiWant() {
  console.log("I'm printing a message!");
}
...
function myMessage(){
  let message = READLINE.question("Type up a message: ");
  let numberOfPrint = READLINE.question("Do you want to print your message once or five times? ")
  if (numberOfPrint == "five times" || numberOfPrint == "five"){
    console.log(`${message}`);
    console.log(`${message}`);
    console.log(`${message}`);
    console.log(`${message}`);
  ...
  else if(numberOfPrint == "once" || numberOfPrint == "one time"){
    console.log(`${message}`);
...
//dont need to set talking == true nbecause talking is a boolean
